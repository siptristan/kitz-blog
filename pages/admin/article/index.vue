        ...
        <tbody v-if="blogs.length > 0">
          ...
          >
            ...
            <td class="py-4 px-6 flex">
              <nuxt-link :to="`/admin/article/${item.BlogID}`">
              ...
              <p class="mx-2">|</p>
              <a href="javascript:void(0)" @click="editBlog(blog.page, item.BlogID)" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                ...
                <p class="mx-2">|</p>
              <a href="javascript:void(0)" @click="deleteBlog(item.BlogID)" class="font-medium text-red-600 dark:text-blue-500 hover:underline">
